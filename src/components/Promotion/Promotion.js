      ...
      <div className="promotion-list">
        <div className="promotion-item">
          ...
          <div className="promotion-detail">
            <h2 className="promotion-name">
              {" "}
              50% OFF FOR SECOND PIZZA - ALL WEEK
            </h2>
        ...
        <div className="promotion-item">
          ...
          <div className="promotion-detail">
            ...
            <div className="promotion-description">
              * Combo 129,000đ include: 1 Kid Mania Pizza 9'' + 1 Sausage + 1
              Coca.
              <br />
              * Free 30' delivery with this order within delivery range.
              <br />
            </div>
            <NavLink to="/pizza">
              <button className="promotion-button">ORDER NOW</button>
